...
var MobileDetection = function() {
	...
	this.nexus = function() {
		return userAgent.indexOf('nexus') !== -1;
	};
	...
	this.sony = function() {
		return userAgent.indexOf('sony') !== -1;
	};
	...
	this.samsung = function() {
		return userAgent.indexOf('gt-') !== -1 || userAgent.indexOf('galaxy') !== -1 || userAgent.indexOf('samsung') !== -1;
	};
